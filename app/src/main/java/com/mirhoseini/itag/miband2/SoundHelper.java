package com.mirhoseini.itag.miband2;
...
import com.mirhoseini.itag.Mainmiband2Activity;
...
public class SoundHelper {
    ...
    private MediaPlayer getMediaPlayer( String localFileName) {
        ...
        if (mp == null) {
            ...
            Log.d(Mainmiband2Activity.LOG_TAG, logMessage);
    ...
    private void addSound(String shortName) {
        ...
        Log.d(Mainmiband2Activity.LOG_TAG, "Added voice: " + shortName);
    ...
    public void playAllAsync() {
        Thread r = new Thread() {
            ...
            public void  run() {
                int counter = 0;
                for (MediaPlayer m : loadedSounds) {
                    Log.d(Mainmiband2Activity.LOG_TAG, "Playing sound no. " + counter);
                    m.start();
                    while (m.isPlaying()) {
                        try {
    ...
    private void raisePlayBackFinishEvent() {
        Log.d(Mainmiband2Activity.LOG_TAG, "Playback Finished!");

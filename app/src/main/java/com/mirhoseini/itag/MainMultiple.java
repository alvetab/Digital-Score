...
public class MainMultiple extends AppCompatActivity implements IMultiBLEAccelServiceDelegate {
    ...
    private void showAvailableBleDevices() {
        ...
        final AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(MainMultiple.this);
    ...
    private Button.OnClickListener showAvailableDevices = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            final ProgressDialog progressDialog =
                    ProgressDialog.show(MainMultiple.this,
                            title,
                            message,
                            true);

package com.mirhoseini.itag.pulsadores.devices;
 ...
 */
public class DeviceAlertDialogFragment
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState)
    {
       ...
       /* final Button espdata = (Button) alertView.findViewById(R.id.espdata);
        espdata.setEnabled(checked);*/
        ...
        alert.setOnClickListener(new View.OnClickListener() {
         ...
         //final Button espdata = (Button) alertView.findViewById(R.id.espdata);
           // espdata.setOnClickListener(new View.OnClickListener() {
            //@Override
            //public void onClick(View view)
            //{
              //  ((OnConfirmAlertDialogListener) getActivity()).sendData(address, BluetoothLEService.DATA);
             /*   final String initialText = getActivity().getString(R.string.start_immediate_alert);
                if (alert.getText().equals(initialText)) {
                    ((OnConfirmAlertDialogListener) getActivity()).doAlertClick(address, BluetoothLEService.HIGH_ALERT);
                    alert.setText(R.string.stop_immediate_alert);
    ...
    public interface OnConfirmAlertDialogListener {
        ...
        //void sendData(final String address, final String data);
